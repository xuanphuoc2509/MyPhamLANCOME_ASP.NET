...
namespace CosmeticsShop.Controllers
{
    ...
    {
        ShoppingEntities1 db = new ShoppingEntities1();
        [HttpPost]
        ...
        public ActionResult AddOrder(string payment = "")
        {
            ...
            int orderID = db.Orders.OrderByDescending(p => p.ID).FirstOrDefault().ID;
            ...
            // Xóa giỏ hàng và thông tin đơn hàng khỏi session
            Session.Remove("Cart");
            Session.Remove("OrderID");

          
            return RedirectToAction( "AddOder","Cart", new { mess = "Đặt hàng thành công" });
